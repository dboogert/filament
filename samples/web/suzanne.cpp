...
// This is explicitly called after our JavaScript layer creates a WebGL 2.0 context.
extern "C" void launch() {
    WebApp::get()->run(setup, cleanup, gui, animate);
}

// This is implicitly called after JIT compilation, but before the WebGL context has been created.
int main() {
    WebApp::get();
}
